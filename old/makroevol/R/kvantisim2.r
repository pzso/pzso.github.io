##---- Kvantitatív jellegek, 2. szimuláció: szelekció------------##
...
maxt<-5  #generációk száma az F2 generációtól
np<-300  #szülõk, egyedszám (np <= n) 
...
#--- További generációk (1 populáció): irányító szelekció
for(ss in 1:maxt) {
